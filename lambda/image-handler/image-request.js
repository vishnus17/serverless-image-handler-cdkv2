...
class ImageRequest {
    ...
    setup(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const originalImage = yield this.getOriginalImage(imageRequestInfo.bucket, imageRequestInfo.key);
                ...
                if (imageRequestInfo.contentType !== 'image/svg+xml' || imageRequestInfo.edits.toFormat || imageRequestInfo.outputFormat) {
                    ...
                    if (outputFormat === lib_1.ImageFormatTypes.WEBP && imageRequestInfo.requestType === lib_1.RequestTypes.DEFAULT) {
                ...
                if (imageRequestInfo.outputFormat) {
                    ...
                    const acceptedValues = [lib_1.ImageFormatTypes.JPEG, lib_1.ImageFormatTypes.PNG, lib_1.ImageFormatTypes.WEBP, lib_1.ImageFormatTypes.TIFF, lib_1.ImageFormatTypes.HEIF];
                    ...
                    if (requestType.includes(imageRequestInfo.requestType) && acceptedValues.includes(imageRequestInfo.outputFormat)) {
                        const qualityKey = Object.keys(imageRequestInfo.edits).filter(key => acceptedValues.includes(key))[0];
    ...
    getOriginalImage(bucket, key) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                result.cacheControl = (_a = originalImage.CacheControl) !== null && _a !== void 0 ? _a : 'max-age=31536000,public';
    ...
    parseImageEdits(event, requestType) {
        if (requestType === lib_1.RequestTypes.DEFAULT) {
            ...
            throw new lib_1.ImageHandlerError(lib_1.StatusCodes.BAD_REQUEST, 'ImageEdits::CannotParseEdits', 'The edits you provided could not be parsed. Please check the syntax of your request and refer to the documentation for additional guidance.');
        }
    }
    /**
    ...
    parseImageKey(event, requestType) {
        ...
        throw new lib_1.ImageHandlerError(lib_1.StatusCodes.NOT_FOUND, 'ImageEdits::CannotFindImage', 'The image you specified could not be found. Please check your request syntax as well as the bucket you specified to ensure it exists.');
    }
    /**
    ...
    parseRequestType(event) {
        ...
        if (matchDefault.test(path) && isBase64Encoded) {
            ...
            throw new lib_1.ImageHandlerError(lib_1.StatusCodes.BAD_REQUEST, 'RequestTypeError', 'The type of request you are making could not be processed. Please ensure that your original image is of a supported file type (jpg, png, tiff, webp, svg) and that your image request is provided in the correct syntax. Refer to the documentation for additional guidance on forming image requests.');
        }
    }
    /**
    ...
    decodeRequest(event) {
        ...
        if (path) {
            ...
            try {
                ...
                throw new lib_1.ImageHandlerError(lib_1.StatusCodes.BAD_REQUEST, 'DecodeRequest::CannotDecodeRequest', 'The image request you provided could not be decoded. Please check that your request is base64 encoded properly and refer to the documentation for additional guidance.');
            }
        }
        else {
            throw new lib_1.ImageHandlerError(lib_1.StatusCodes.BAD_REQUEST, 'DecodeRequest::CannotReadPath', 'The URL path you provided could not be read. Please ensure that it is properly formed according to the solution documentation.');
        }
    }
    /**
    ...
    validateRequestSignature(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ENABLE_SIGNATURE === 'Yes') {
                ...
                if (!(queryStringParameters === null || queryStringParameters === void 0 ? void 0 : queryStringParameters.signature)) {
                    throw new lib_1.ImageHandlerError(lib_1.StatusCodes.BAD_REQUEST, 'AuthorizationQueryParametersError', 'Query-string requires the signature parameter.');
                }
                try {
                    ...
                    if (signature !== hash) {
                        throw new lib_1.ImageHandlerError(lib_1.StatusCodes.FORBIDDEN, 'SignatureDoesNotMatch', 'Signature does not match.');
                    }
                }
                catch (error) {
                    ...
                    throw new lib_1.ImageHandlerError(lib_1.StatusCodes.INTERNAL_SERVER_ERROR, 'SignatureValidationFailure', 'Signature validation failed.');
                }
            }
        });
    }
